...
The project investigates vision transformer with **different normalization methods (LN, GN, BN)**, or **training without normalization and without performance degradation**.
