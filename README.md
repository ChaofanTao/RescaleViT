...
The project investigates vision transformer with **different normalization methods (LN, GN, BN)**, or **training without normalization and without performance degradation**. [[PDF]](https://github.com/ChaofanTao/RescaleViT/blob/master/RescaleViT%20Training%20Vision%20Transformer%20without%20Normalization.pdf)
